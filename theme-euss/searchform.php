...
?>
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( is_rtl() ? __( 'بحث الموقع', 'theme-euss' ) : __( 'Site search', 'theme-euss' ) ); ?>">
