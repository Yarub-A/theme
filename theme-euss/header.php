...
<head>
    ...
    <script type="application/ld+json">
        <?php echo wp_json_encode( array_filter( $theme_euss_schema_org ), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ); ?>
    </script>
</head>
<body <?php body_class(); ?>>
<?php
    ...
    <div class="top-bar py-2">
        <div class="container">
            <div class="top-bar-grid">
                ...
                <div class="top-bar-actions d-none d-lg-flex">
