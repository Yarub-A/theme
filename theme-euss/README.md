...
## إدارة المحتوى
- الهيدر يتكوّن من شريط علوي قابل للتحرير عبر ويدجات **Header Top Brand** و **Header Top Actions** مع البحث المدمج، بينما تُدار روابط النافبار عبر قوائم Polylang لكل لغة.
- الفوتر يضم أربع أعمدة ويدجات (**Footer Column 1-4**) يمكن تخصيص محتواها من لوحة التحكم دون تعديل الكود، مع بقاء القوائم السفلية مترجمة.
- صفحة الخيارات (ACF) متاحة تحت **EUSS Options** لإدارة بيانات الاتصال، الخريطة، وروابط الشبكات.
- الصفحة الرئيسية تُنشأ باستخدام كتل Gutenberg قابلة للتحرير بالكامل (Hero، أعمدة تعريفية)، ويمكن إدراج شبكات الأخبار والشركاء عبر الشورتكودين `[theme_euss_news_grid]` و`[theme_euss_partners]`.
