...
function theme_euss_language_switcher( $context = 'desktop' ) {
    $context = in_array( $context, [ 'desktop', 'mobile' ], true ) ? $context : 'desktop';
    ...
    if ( function_exists( 'pll_the_languages' ) ) {
        ...
        echo '<button class="btn btn-language-toggle" type="button" id="' . esc_attr( $button_id ) . '" data-bs-toggle="dropdown" aria-expanded="false">';
        echo $icon_svg;
        echo '<span class="language-code">' . esc_html( $current_code ) . '</span>';
        echo '<span class="language-name">' . esc_html( $current_name ) . '</span>';
        echo '</button>';
        echo '<ul class="dropdown-menu ' . esc_attr( $alignment ) . '" aria-labelledby="' . esc_attr( $button_id ) . '">';
        foreach ( $languages as $language ) {
            ...
            echo '<li><a class="' . esc_attr( $item_cls ) . '" href="' . esc_url( $language['url'] ) . '"' . $current . '>';
    ...
    foreach ( $fallback_languages as $lang ) {
        echo '<li><a class="dropdown-item" href="' . esc_url( $lang['url'] ) . '">';
