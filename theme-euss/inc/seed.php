...
HTML
            ...
            'colleges' => [
                'ar' => <<<'HTML'
<!-- wp:list -->
<ul><li>كلية العلوم التطبيقية</li><li>كلية الإدارة والاقتصاد</li><li>كلية القانون والعلوم السياسية</li><li>كلية الهندسة وتكنولوجيا المعلومات</li><li>كلية التربية والعلوم الإنسانية</li><li>كلية العلوم الطبية المساعدة</li><li>كلية الآداب واللغات</li><li>كلية الدراسات العليا والبحث العلمي</li></ul>
<!-- /wp:list -->
HTML
                , // PDF p.7
                'en' => <<<'HTML'
<!-- wp:list -->
<ul><li>College of Applied Sciences</li><li>College of Administration and Economics</li><li>College of Law and Political Sciences</li><li>College of Engineering and Information Technology</li><li>College of Education and Human Sciences</li><li>College of Allied Medical Sciences</li><li>College of Arts and Languages</li><li>College of Graduate Studies and Scientific Research</li></ul>
<!-- /wp:list -->
HTML
                , // PDF p.7
            ],
...
HTML
            ...
            'about-centers-language' => [
                'ar' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: وصف تفصيلي لمركز تعليم اللغات والترجمة القانونية مع إبراز خدماته وبرامجه. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
                'en' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: Provide detailed description for the Language & Legal Translation Center, highlighting its programmes and services. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
            ],
            'about-centers-development' => [
                'ar' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: إضافة معلومات موسعة حول مركز التأهيل والتطوير التربوي وأهدافه. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
                'en' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: Add expanded information about the Educational Development Center and its objectives. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
            ],
            'about-centers-cultural' => [
                'ar' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: استكمال تفاصيل نشاطات المركز الثقافي السويدي العراقي ضمن الجامعة. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
                'en' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: Complete details for the Swedish-Iraqi Cultural Center activities within the university. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
            ],
            'about-centers-innovation' => [
                'ar' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: توثيق برامج وخدمات مركز الإبداع والابتكار الخاصة بالطلبة والباحثين. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
                'en' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: Document the programmes and services of the Innovation & Creativity Center for students and researchers. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
            ],
            'about-centers-psychology' => [
                'ar' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: إدراج محتوى تفصيلي حول مركز الاستشارات النفسية ودعمه لطلبة الجامعة. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
                'en' => <<<'HTML'
<!-- wp:paragraph -->
<p>TODO: Insert detailed content for the Psychological Counseling Center and its support services. // PDF p.21-22</p>
<!-- /wp:paragraph -->
HTML
                ,
            ],
                ...
                'about-centers' => [
                    ...
                    'children'    => [
                        'about-centers-language' => [
                            ...
                            'translations' => [
                                'ar' => [
                                    'title'   => 'مركز تعليم اللغات والترجمة القانونية',
                                    'slug'    => 'about-centers-language-ar',
                                    'content' => theme_euss_seed_page_content( 'about-centers-language', 'ar' ),
                                ],
                                'en' => [
                                    'title'   => 'Language & Legal Translation Center',
                                    'slug'    => 'about-centers-language',
                                    'content' => theme_euss_seed_page_content( 'about-centers-language', 'en' ),
                                ],
                            ],
                        ],
                        'about-centers-development' => [
                            ...
                            'translations' => [
                                'ar' => [
                                    'title'   => 'مركز التأهيل والتطوير التربوي',
                                    'slug'    => 'about-centers-development-ar',
                                    'content' => theme_euss_seed_page_content( 'about-centers-development', 'ar' ),
                                ],
                                'en' => [
                                    'title'   => 'Educational Development Center',
                                    'slug'    => 'about-centers-development',
                                    'content' => theme_euss_seed_page_content( 'about-centers-development', 'en' ),
                                ],
                            ],
                        ],
                        'about-centers-cultural' => [
                            ...
                            'translations' => [
                                'ar' => [
                                    'title'   => 'المركز الثقافي السويدي العراقي',
                                    'slug'    => 'about-centers-cultural-ar',
                                    'content' => theme_euss_seed_page_content( 'about-centers-cultural', 'ar' ),
                                ],
                                'en' => [
                                    'title'   => 'Swedish-Iraqi Cultural Center',
                                    'slug'    => 'about-centers-cultural',
                                    'content' => theme_euss_seed_page_content( 'about-centers-cultural', 'en' ),
                                ],
                            ],
                        ],
                        'about-centers-innovation' => [
                            ...
                            'translations' => [
                                'ar' => [
                                    'title'   => 'مركز الإبداع والابتكار',
                                    'slug'    => 'about-centers-innovation-ar',
                                    'content' => theme_euss_seed_page_content( 'about-centers-innovation', 'ar' ),
                                ],
                                'en' => [
                                    'title'   => 'Innovation Center',
                                    'slug'    => 'about-centers-innovation',
                                    'content' => theme_euss_seed_page_content( 'about-centers-innovation', 'en' ),
                                ],
                            ],
                        ],
                        'about-centers-psychology' => [
                            ...
                            'translations' => [
                                'ar' => [
                                    ...
                                    'slug'    => 'about-centers-psychology-ar',
                                    'content' => theme_euss_seed_page_content( 'about-centers-psychology', 'ar' ),
                                ],
                                'en' => [
                                    'title'   => 'Psychological Counseling Center',
                                    'slug'    => 'about-centers-psychology',
                                    'content' => theme_euss_seed_page_content( 'about-centers-psychology', 'en' ),
                                ],
                            ],
                        ],
                    ],
...
function theme_euss_create_page_branch( array $nodes, array $parent_ids, array &$flat ) {
    foreach ( $nodes as $key => $node ) {
        ...
        foreach ( $translations as $lang => $data ) {
            ...
            $seed_key  = sanitize_key( 'page-' . $key . '-' . $lang );
            $created_ids[ $lang ] = theme_euss_upsert_page( $data, $node['template'], $parent_id, $lang, $seed_key );
...
function theme_euss_upsert_page( array $page_data, $template, $parent_id = 0, $lang = '', $seed_key = '' ) {
    $defaults = [
    ...
    $seed_key  = sanitize_key( $seed_key );
    $existing  = null;
    ...
    if ( ! $existing && '' !== $slug ) {
        $slug_candidate = get_page_by_path( $slug );
        if ( $slug_candidate instanceof WP_Post && theme_euss_seed_post_language_matches( $slug_candidate->ID, $lang ) ) {
            $existing = $slug_candidate;
        }
    }
    ...
    if ( ! $existing && '' !== $slug ) {
        $existing_candidates = get_posts(
            [
                ...
                'post_status' => 'any',
                'numberposts' => 1,
                'meta_key'    => theme_euss_seed_slug_meta_key( $lang ),
                'meta_value'  => $slug,
            ]
        );
    ...
    if ( $page_id && $seed_key ) {
        update_post_meta( $page_id, '_theme_euss_seed_key', $seed_key );
    }

    if ( $page_id && $lang ) {
        update_post_meta( $page_id, theme_euss_seed_slug_meta_key( $lang ), $slug );
    }

    return $page_id;
}

function theme_euss_seed_menu_fragment( array $item ) {
    ...
    if ( isset( $item['type'] ) ) {
        ...
        if ( 'custom' === $type && ! empty( $item['url'] ) ) {
            return $type . '-' . substr( md5( strtolower( (string) $item['url'] ) ), 0, 12 );
        }

        if ( '' !== $object ) {
            $slug = sanitize_key( $item['slug'] ?? '' );
            return implode( '-', array_filter( [ $type, $object, $slug ] ) );
        }
    ...
    if ( isset( $item['url'] ) && '' !== $item['url'] ) {
        return 'custom-' . substr( md5( strtolower( (string) $item['url'] ) ), 0, 12 );
    }

    return substr( md5( wp_json_encode( $item ) ), 0, 12 );
}

function theme_euss_seed_menu_path( $parent_path, $fragment ) {
...
function theme_euss_seed_menu_meta_value( $menu_location, $lang, $path ) {
    $menu_location = sanitize_key( $menu_location );
    $lang          = sanitize_key( $lang );
    $path          = trim( preg_replace( '#/{2,}#', '/', (string) $path ), '/' );

    if ( '' === $path ) {
        $path = 'root';
    }

    return 'menu:' . $menu_location . ':' . $lang . ':' . $path;
}

function theme_euss_seed_menu_legacy_key( $menu_type, $object_name, $object_id, $parent_item_id, $menu_url = '' ) {
    $parts = [ sanitize_key( $menu_type ), sanitize_key( $object_name ), (int) $object_id, (int) $parent_item_id ];

    if ( 'custom' === $menu_type ) {
        $parts[] = md5( (string) $menu_url );
    }

    return implode( ':', $parts );
}

function theme_euss_seed_menu_legacy_key_from_post( $menu_item ) {
...
function theme_euss_seed_purge_menu_items( $menu_id ) {
    $menu_id = (int) $menu_id;
...
function theme_euss_create_menus( $pages, $posts = [] ) {
    ...
    foreach ( $locations as $location => $key ) {
        ...
        if ( ! $menu ) {
            ...
            theme_euss_seed_purge_menu_items( $menu_id );
        }
    ...
    $colleges_branch = [
        [
            ...
            'children' => [
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'ai' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'computer-software' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'nursing-medical' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'agro-industrial' ],
            ],
        ],
        [
            'type'     => 'post_type',
            ...
            'children' => [
                ...
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'finance-banking' ],
            ],
        ],
        [
            'type'     => 'post_type',
            ...
            'children' => [
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'law' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'political-science' ],
            ],
        ],
        [
            'type'     => 'post_type',
            ...
            'children' => [
                ...
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'quality-inspection' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'electrical-engineering' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'engineering-projects' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'biomedical-engineering' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'medical-devices' ],
            ],
        ],
        [
            'type'     => 'post_type',
        ...
        [
            ...
            'children' => [
                ...
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'clinical-nutrition' ],
            ],
        ],
        [
            'type'     => 'post_type',
            ...
            'slug'     => 'arts-languages',
            'children' => [
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'arabic-native' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'arabic-non-native' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'english-language' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'swedish-language' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'french-language' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'translation' ],
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'sociology' ],
            ],
        ],
        [
            'type'     => 'post_type',
            ...
            'children' => [
                [ 'type' => 'taxonomy', 'object' => 'departments', 'slug' => 'postdoctoral' ],
            ],
        ],
    ];
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'key'      => 'about-centers',
                        'children' => [
                            [ 'key' => 'about-centers-language' ],
                            [ 'key' => 'about-centers-development' ],
                            [ 'key' => 'about-centers-cultural' ],
                            [ 'key' => 'about-centers-innovation' ],
                            [ 'key' => 'about-centers-psychology' ],
                        ],
                    ],
    ...
    set_theme_mod( 'nav_menu_locations', array_merge( $current_locations, $seed_locations ) );
}

function theme_euss_sync_menu_branch( array $items, array $pages, array $posts, $menu_id, $lang, $parent_item_id, array &$existing_map, array &$used_items, $parent_path, $menu_location ) {
    foreach ( $items as $item ) {
        if ( is_string( $item ) ) {
            $item = [ 'key' => $item ];
        }
        ...
        if ( isset( $item['type'] ) ) {
            switch ( $item['type'] ) {
                case 'post_type':
                    ...
                    if ( empty( $post_type ) || empty( $slug ) || empty( $posts[ $post_type ][ $slug ][ $lang ] ?? 0 ) ) {
                        $skip_item = true;
                        break;
                    }
                ...
                case 'taxonomy':
                    ...
                    if ( 'ar' === $lang ) {
                        $localized_candidates[] = $slug;
                        $localized_candidates[] = $slug . '-ar';
                    } else {
                        $localized_candidates[] = $slug . '-en';
                        $localized_candidates[] = $slug;
                    }

                    $term = null;

                    foreach ( $localized_candidates as $candidate_slug ) {
                        $candidate_slug = sanitize_title( $candidate_slug );
        ...
        if ( 0 === $object_id && 'custom' !== $menu_type ) {
            ...
            if ( '' === $item_key || empty( $pages[ $item_key ][ $lang ] ?? 0 ) ) {
                continue;
            }

            $object_id = (int) ( $pages[ $item_key ][ $lang ] ?? 0 );
        ...
        $fragment       = theme_euss_seed_menu_fragment( $item );
        $seed_path      = theme_euss_seed_menu_path( $parent_path, $fragment );
...
function theme_euss_seed_terms() {
    $departments = [
        [ 'ar' => 'الذكاء الاصطناعي', 'en' => 'Artificial Intelligence', 'slug' => 'ai' ], // PDF p.10
        [ 'ar' => 'الحاسوب والبرمجيات', 'en' => 'Computer & Software', 'slug' => 'computer-software' ], // PDF p.10
        [ 'ar' => 'التمريض والخدمات الطبية', 'en' => 'Nursing & Medical Services', 'slug' => 'nursing-medical' ], // PDF p.10
        [ 'ar' => 'التصنيع الزراعي', 'en' => 'Agro-Industrial', 'slug' => 'agro-industrial' ], // PDF p.10
        ...
        [ 'ar' => 'العلوم المالية والمصرفية', 'en' => 'Finance & Banking', 'slug' => 'finance-banking' ], // PDF p.11
        [ 'ar' => 'القانون', 'en' => 'Law', 'slug' => 'law' ], // PDF p.12
        [ 'ar' => 'العلوم السياسية', 'en' => 'Political Science', 'slug' => 'political-science' ], // PDF p.12
        [ 'ar' => 'هندسة الحاسبات', 'en' => 'Computer Engineering', 'slug' => 'computer-engineering' ], // PDF p.13
        [ 'ar' => 'هندسة الفحص والسيطرة النوعية', 'en' => 'Quality Inspection & Control Engineering', 'slug' => 'quality-inspection' ], // PDF p.13
        [ 'ar' => 'الهندسة الكهربائية', 'en' => 'Electrical Engineering', 'slug' => 'electrical-engineering' ], // PDF p.13
        [ 'ar' => 'إدارة المشاريع الهندسية', 'en' => 'Engineering Project Management', 'slug' => 'engineering-projects' ], // PDF p.13
        [ 'ar' => 'الهندسة الطبية الحيوية', 'en' => 'Biomedical Engineering', 'slug' => 'biomedical-engineering' ], // PDF p.13
        [ 'ar' => 'هندسة الأجهزة والمعدات الطبية', 'en' => 'Medical Devices Engineering', 'slug' => 'medical-devices' ], // PDF p.13
        [ 'ar' => 'العلوم التربوية', 'en' => 'Educational Sciences', 'slug' => 'educational-sciences' ], // PDF p.14
        [ 'ar' => 'علم النفس', 'en' => 'Psychology', 'slug' => 'psychology' ], // PDF p.14
        [ 'ar' => 'الإرشاد النفسي والتوجيه التربوي', 'en' => 'Counseling & Guidance', 'slug' => 'counseling-guidance' ], // PDF p.14
        [ 'ar' => 'التربية الخاصة', 'en' => 'Special Education', 'slug' => 'special-education' ], // PDF p.14
        [ 'ar' => 'العلوم الشرعية', 'en' => 'Islamic Studies', 'slug' => 'islamic-studies' ], // PDF p.14
        [ 'ar' => 'الصحة العامة', 'en' => 'Public Health', 'slug' => 'public-health' ], // PDF p.15
        [ 'ar' => 'التغذية العلاجية', 'en' => 'Clinical Nutrition', 'slug' => 'clinical-nutrition' ], // PDF p.15
        [ 'ar' => 'اللغة العربية للناطقين بها', 'en' => 'Arabic for Native Speakers', 'slug' => 'arabic-native' ], // PDF p.16
        [ 'ar' => 'اللغة العربية لغير الناطقين بها', 'en' => 'Arabic for Non-Native Speakers', 'slug' => 'arabic-non-native' ], // PDF p.16
        [ 'ar' => 'اللغة الإنجليزية', 'en' => 'English Language', 'slug' => 'english-language' ], // PDF p.16
        [ 'ar' => 'اللغة السويدية', 'en' => 'Swedish Language', 'slug' => 'swedish-language' ], // PDF p.16
        [ 'ar' => 'اللغة الفرنسية', 'en' => 'French Language', 'slug' => 'french-language' ], // PDF p.16
        [ 'ar' => 'الترجمة', 'en' => 'Translation', 'slug' => 'translation' ], // PDF p.16
        [ 'ar' => 'علم الاجتماع', 'en' => 'Sociology', 'slug' => 'sociology' ], // PDF p.16
        [ 'ar' => 'مرحلة ما بعد الدكتوراه', 'en' => 'Postdoctoral Studies', 'slug' => 'postdoctoral' ], // PDF p.17
    ];
    $programs = [
...
function theme_euss_seed_posts() {
    ...
    $colleges = [
        [
            ...
            'translations' => [
                'ar' => [
                    'title'   => 'كلية العلوم التطبيقية', // PDF p.7
                    'slug'    => 'applied-sciences-ar',
                    'content' => "<!-- wp:list --><ul><li>الذكاء الاصطناعي</li><li>الحاسوب والبرمجيات</li><li>التمريض والخدمات الطبية</li><li>التصنيع الزراعي</li></ul><!-- /wp:list -->",
                ],
                'en' => [
                    'title'   => 'College of Applied Sciences', // PDF p.7
                    'slug'    => 'applied-sciences',
                    'content' => "<!-- wp:list --><ul><li>Artificial Intelligence</li><li>Computer &amp; Software</li><li>Nursing &amp; Medical Services</li><li>Agro-Industrial</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
            ...
            'translations' => [
                'ar' => [
                    ...
                    'slug'    => 'administration-economics-ar',
                ...
                'en' => [
                    ...
                    'slug'    => 'administration-economics',
                    'content' => "<!-- wp:list --><ul><li>Business Administration</li><li>Information Systems</li><li>Finance &amp; Banking</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
        ...
        [
            ...
            'translations' => [
                'ar' => [
                    'title'   => 'كلية الهندسة وتكنولوجيا المعلومات', // PDF p.7
                    'slug'    => 'engineering-information-technology-ar',
                    'content' => "<!-- wp:list --><ul><li>هندسة الحاسبات</li><li>هندسة الفحص والسيطرة النوعية</li><li>الهندسة الكهربائية</li><li>إدارة المشاريع الهندسية</li><li>الهندسة الطبية الحيوية</li><li>هندسة الأجهزة والمعدات الطبية</li></ul><!-- /wp:list -->",
                ],
                'en' => [
                    'title'   => 'College of Engineering and Information Technology', // PDF p.7
                    'slug'    => 'engineering-information-technology',
                    'content' => "<!-- wp:list --><ul><li>Computer Engineering</li><li>Quality Inspection &amp; Control Engineering</li><li>Electrical Engineering</li><li>Engineering Project Management</li><li>Biomedical Engineering</li><li>Medical Devices Engineering</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
            ...
            'translations' => [
                'ar' => [
                    'title'   => 'كلية التربية والعلوم الإنسانية', // PDF p.7
                    'slug'    => 'education-human-sciences-ar',
                ...
                'en' => [
                    'title'   => 'College of Education and Human Sciences', // PDF p.7
                    'slug'    => 'education-human-sciences',
                    'content' => "<!-- wp:list --><ul><li>Educational Sciences</li><li>Psychology</li><li>Counseling &amp; Guidance</li><li>Special Education</li><li>Islamic Studies</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
            ...
            'translations' => [
                'ar' => [
                    ...
                    'slug'    => 'allied-medical-sciences-ar',
                    'content' => "<!-- wp:list --><ul><li>الصحة العامة</li><li>التغذية العلاجية</li></ul><!-- /wp:list -->",
                ],
                'en' => [
                    'title'   => 'College of Allied Medical Sciences', // PDF p.7
                    'slug'    => 'allied-medical-sciences',
                    'content' => "<!-- wp:list --><ul><li>Public Health</li><li>Clinical Nutrition</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
            ...
            'translations' => [
                'ar' => [
                    ...
                    'slug'    => 'arts-languages-ar',
                    'content' => "<!-- wp:list --><ul><li>اللغة العربية للناطقين بها</li><li>اللغة العربية لغير الناطقين بها</li><li>اللغة الإنجليزية</li><li>اللغة السويدية</li><li>اللغة الفرنسية</li><li>الترجمة</li><li>علم الاجتماع</li></ul><!-- /wp:list -->",
                ],
                'en' => [
                    'title'   => 'College of Arts and Languages', // PDF p.7
                    'slug'    => 'arts-languages',
                    'content' => "<!-- wp:list --><ul><li>Arabic for Native Speakers</li><li>Arabic for Non-Native Speakers</li><li>English Language</li><li>Swedish Language</li><li>French Language</li><li>Translation</li><li>Sociology</li></ul><!-- /wp:list -->",
                ],
            ],
        ],
        [
            ...
            'translations' => [
                'ar' => [
                    ...
                    'slug'    => 'graduate-studies-research-ar',
                    'content' => "<!-- wp:paragraph --><p>تشرف الكلية على برامج الماجستير والدكتوراه ومرحلة ما بعد الدكتوراه مع حاضنات بحثية تدعم مشاريع التنمية والابتكار.</p><!-- /wp:paragraph -->",
                ],
                'en' => [
                    'title'   => 'College of Graduate Studies and Scientific Research', // PDF p.7
                    'slug'    => 'graduate-studies-research',
                    'content' => "<!-- wp:paragraph --><p>The college oversees master, doctoral, and postdoctoral pathways supported by research incubators that foster development and innovation.</p><!-- /wp:paragraph -->",
                ],
            ],
        ],
    ];
...
function theme_euss_upsert_translated_post( array $item ) {
    ...
    foreach ( $translations as $lang => $data ) {
        ...
        $seed_key         = sanitize_key( $item['post_type'] . '-' . $item['slug'] . '-' . $lang );
        $existing_post_id = theme_euss_seed_find_existing_post( $item['post_type'], $slug, $lang, $seed_key );
        ...
        if ( $existing_post_id > 0 ) {
            ...
            $update_result = wp_update_post( $update, true );

            if ( is_wp_error( $update_result ) ) {
                continue;
            }

            $post_id = ( $update_result ) ? (int) $update_result : $existing_post_id;
        } else {
        ...
        update_post_meta( $post_id, '_theme_euss_seed_key', $seed_key );
        update_post_meta( $post_id, theme_euss_seed_slug_meta_key( $lang ), $slug );
...
function theme_euss_seed_find_existing_post( $post_type, $slug, $lang, $seed_key ) {
    ...
    $queries[] = array_merge( $base_args, [
        'meta_key'   => '_theme_euss_seed_key',
        'meta_value' => $seed_key,
    ] );

    if ( '' !== $slug ) {
        $queries[] = array_merge( $base_args, [ 'name' => $slug ] );
        $queries[] = array_merge( $base_args, [
            'meta_key'   => theme_euss_seed_slug_meta_key( $lang ),
            'meta_value' => $slug,
        ] );
    ...
    foreach ( $queries as $args ) {
        ...
        foreach ( $candidates as $candidate ) {
            ...
            if ( theme_euss_seed_post_language_matches( $candidate->ID, $lang ) ) {
...
function theme_euss_seed_post_language_matches( $post_id, $lang ) {
...
function theme_euss_seed_slug_meta_key( $lang ) {
    return sanitize_key( '_theme_euss_seed_slug_' . $lang );
}
