    ...
    static function() {
        ...
        register_block_pattern(
            ...
            [
                ...
                'categories'  => [ 'euss' ],
                'content'     => '<section class="hero-section text-center text-lg-start"><div class="container"><div class="row align-items-center"><div class="col-lg-7"><h1 class="display-5 fw-bold">' . esc_html__( 'European University for Smart Sciences', 'theme-euss' ) . '</h1><p class="lead">' . esc_html__( 'Founded in Gothenburg in 2019/2020 to deliver blended Arabic, English, and Swedish higher education.', 'theme-euss' ) . '</p></div><div class="col-lg-5"><figure class="text-center"><img class="img-fluid rounded shadow" src="' . esc_url( THEME_EUSS_URI . '/assets/img/placeholder-hero.jpg' ) . '" alt="' . esc_attr__( 'Campus image', 'theme-euss' ) . '" loading="lazy"></figure></div></div></div></section>',
            ]
        );
