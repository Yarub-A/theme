...
<header class="site-header">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                    <span class="quick-links-label text-uppercase fw-bold small text-white d-none d-md-inline">
                        <?php echo is_rtl() ? esc_html__( 'روابط سريعة', 'theme-euss' ) : esc_html__( 'Quick Links', 'theme-euss' ); ?>
                    </span>
                    <nav class="top-menu" aria-label="Top menu">
                        ...
                        wp_nav_menu( [
                            ...
                            'container'      => false,
                            'menu_class'     => 'nav small top-links',
    ...
    <nav class="navbar navbar-expand-lg navbar-dark main-navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainMenu">
                ...
                ?>
                <div class="navbar-cta ms-lg-4 mt-3 mt-lg-0">
                    <a class="btn btn-apply" href="<?php echo esc_url( home_url( is_rtl() ? '/admissions-ar' : '/admissions' ) ); ?>">
                        <?php echo is_rtl() ? esc_html__( 'قدّم الآن', 'theme-euss' ) : esc_html__( 'Apply Now', 'theme-euss' ); ?>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-<?php echo is_rtl() ? 'end' : 'start'; ?> text-bg-dark" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
        ...
        <div class="offcanvas-body">
            ...
            ?>
            <div class="mt-4">
                <a class="btn btn-apply w-100" href="<?php echo esc_url( home_url( is_rtl() ? '/admissions-ar' : '/admissions' ) ); ?>">
                    <?php echo is_rtl() ? esc_html__( 'قدّم الآن', 'theme-euss' ) : esc_html__( 'Apply Now', 'theme-euss' ); ?>
                </a>
            </div>
        </div>
