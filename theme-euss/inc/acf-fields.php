...
if ( function_exists( 'acf_add_local_field_group' ) ) {
            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        ...
                        'type'  => 'text',
                        'default_value' => '',
                        'instructions'  => __( 'Optional. Leave empty to hide the button by default.', 'theme-euss' ), // PDF p.23
                    ],
                    [
                    ...
                    [
                        'key'   => 'field_euss_hero_image',
                        'label' => __( 'Hero Image', 'theme-euss' ),
                        'name'  => 'image',
                        'type'  => 'image',
                        'return_format' => 'array',
                        'preview_size'  => 'medium',
    ...
    acf_add_local_field_group( [
        ...
        'title'  => __( 'Research & Collaboration', 'theme-euss' ),
        'fields' => [
            [
