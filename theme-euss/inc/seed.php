...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>تأسست الجامعة الأوروبية للعلوم الذكية في غوتنبورغ السويدية عام 2019/2020 برقم التسجيل 559306-7902، لتكون ملتقى دولياً للتعليم والبحث بثلاث لغات.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>توفر الجامعة برامج بكالوريوس وماجستير ودكتوراه إضافة إلى مسارات مهنية معتمدة تعتمد التعلم المدمج والحضور الافتراضي. <strong>// PDF p.2, p.8-9</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","className":"euss-hero-media"} -->
<div class="wp-block-column is-vertically-aligned-center euss-hero-media"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="%1$s" alt="منظر افتراضي للحرم الجامعي" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
...
<ul><li>برامج أكاديمية معتمدة تغطي البكالوريوس والماجستير والدكتوراه والمسارات المهنية. <strong>// PDF p.8-9</strong></li><li>تعليم مدمج يجمع بين الحضور في غوتنبورغ والمنصة الافتراضية. <strong>// PDF p.2</strong></li><li>إشراف بحثي مستمر يعزز الابتكار وخدمة المجتمع. <strong>// PDF p.2</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:list -->
<ul><li>لغات التدريس: العربية والإنجليزية والسويدية مع بيئة متعددة الثقافات. <strong>// PDF p.6</strong></li><li>اتفاقيات اعتراف أكاديمي وتوأمة مع جامعات عربية وأوروبية وأمريكية موثقة عبر IAO. <strong>// PDF p.25-28</strong></li><li>مراكز متخصصة للغات والابتكار والتأهيل الأكاديمي لخدمة الطلبة. <strong>// PDF p.21-22</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
HTML
, esc_url( THEME_EUSS_URI . '/assets/img/placeholder-hero.jpg' ) ), // PDF p.2, p.6, p.8-9, p.21-22, p.25-28
                'en' => sprintf( <<<'HTML'
<!-- wp:group {"className":"euss-hero-block","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-hero-block"><div class="wp-block-group__inner-container"><!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","className":"euss-hero-content"} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Founded in Gothenburg, Sweden in 2019/2020 under registration 559306-7902, the European University for Smart Sciences unites research-driven learning across Arabic, English, and Swedish.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>The university awards bachelor’s, master’s, doctoral, and professional credentials through blended on-campus and virtual pathways. <strong>// PDF p.2, p.8-9</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","className":"euss-hero-media"} -->
<div class="wp-block-column is-vertically-aligned-center euss-hero-media"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="%1$s" alt="Campus view placeholder" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
...
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:list -->
<ul><li>Accredited academic tracks spanning bachelor’s, master’s, doctoral, and professional pathways. <strong>// PDF p.8-9</strong></li><li>Blended teaching that combines the Gothenburg campus with a modern virtual platform. <strong>// PDF p.2</strong></li><li>Research mentoring that advances innovation and community impact. <strong>// PDF p.2</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:list -->
<ul><li>Languages of instruction: Arabic, English, and Swedish with multicultural support. <strong>// PDF p.6</strong></li><li>Academic recognition and twinning agreements with Arab, European, and American institutions documented via IAO. <strong>// PDF p.25-28</strong></li><li>Specialised centres for languages, innovation, and educational development supporting learners. <strong>// PDF p.21-22</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
