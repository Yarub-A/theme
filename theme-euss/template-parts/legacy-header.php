...
<header class="site-header legacy-header">
    <div class="top-bar py-2">
        <div class="container">
            <div class="top-bar-inner d-flex align-items-center gap-3">
                <div class="top-bar-brand flex-grow-0">
                    <?php
                    if ( has_custom_logo() ) {
                        the_custom_logo();
                ...
                <div class="top-bar-actions ms-auto d-flex align-items-center gap-3">
                    <div class="top-bar-language d-none d-md-flex align-items-center">
                        <?php
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg main-navbar" aria-label="<?php echo esc_attr( is_rtl() ? __( 'التنقل الرئيسي', 'theme-euss' ) : __( 'Main navigation', 'theme-euss' ) ); ?>">
        <div class="container">
            ...
            <div class="mobile-controls d-flex align-items-center gap-3 d-lg-none w-100">
                <?php if ( function_exists( 'theme_euss_language_switcher' ) ) : ?>
                    <div class="mobile-language-switcher order-1">
                        <?php theme_euss_language_switcher( 'mobile' ); ?>
                    </div>
                <?php endif; ?>
                <button class="navbar-toggler order-2 ms-auto" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenu" aria-controls="mobileMenu" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'theme-euss' ); ?>">
