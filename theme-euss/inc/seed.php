...
function theme_euss_seed_page_content( $key, $lang ) {
    ...
    if ( null === $content ) {
        $content = [
            'home' => [
                'ar' => <<<'HTML'
<!-- wp:group {"className":"euss-hero-block","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-hero-block"><div class="wp-block-group__inner-container"><!-- wp:columns {"verticalAlignment":"center"} -->
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","className":"euss-hero-content"} -->
<div class="wp-block-column is-vertically-aligned-center euss-hero-content"><!-- wp:heading {"level":1} -->
<h1>الجامعة الأوروبية للعلوم الذكية</h1>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>جامعة سويدية تأسست في غوتنبورغ عام 2019/2020 برقم التسجيل 559306-7902، وتجمع تعليماً بحثياً بثلاث لغات ضمن بيئة متعددة الثقافات.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>تدمج الجامعة التعليم الحضوري والافتراضي لتأهيل الطلبة بدرجات البكالوريوس والماجستير والدكتوراه والبرامج المهنية المعترف بها دولياً.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons {"className":"euss-hero-buttons"} -->
<div class="wp-block-buttons euss-hero-buttons"><!-- wp:button {"textColor":"neutral","backgroundColor":"secondary"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-neutral-color has-secondary-background-color has-text-color has-background wp-element-button" href="/admissions-ar">قدّم الآن</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","className":"euss-hero-cards"} -->
<div class="wp-block-column is-vertically-aligned-center euss-hero-cards"><!-- wp:group {"className":"euss-feature-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-feature-card"><!-- wp:heading {"level":3} -->
<h3>الفعاليات القادمة</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">امتحانات الفصل للطلبة المقيمين تُجرى في حرم غوتنبورغ مع جلسات تقييم افتراضية للطلبة الدوليين. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-feature-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-feature-card"><!-- wp:heading {"level":3} -->
<h3>الاعتراف بالشهادات</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">الشهادات تصدَّق من كاتب العدل السويدي ووزارة الخارجية والسفارات المعنية وفق نظام الأبوستيل الدولي. <strong>// PDF p.19-20</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-feature-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-feature-card"><!-- wp:heading {"level":3} -->
<h3>نظام الدراسة والاختبارات</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">الطلبة داخل السويد يحضرون حضورياً، بينما يدرس الطلبة خارجها عبر المنصة الافتراضية مع إمكانية أداء الامتحانات في السفارات أو الجامعات الشريكة. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-section euss-section--light","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-section euss-section--light"><div class="wp-block-group__inner-container"><!-- wp:heading {"level":2} -->
<h2>مواعيد رئيسية والاختبارات</h2>
<!-- /wp:heading -->
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:list -->
<ul><li>الامتحانات الحضورية في غوتنبورغ للطلبة المقيمين. <strong>// PDF p.18</strong></li><li>جلسات تقييم افتراضية مباشرة للدارسين عن بعد. <strong>// PDF p.18</strong></li><li>خيارات أداء الامتحانات عبر السفارات السويدية أو الجامعات المتعاونة. <strong>// PDF p.18</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p>يعاد الاختبار في حال عدم اجتيازه ضمن الفترة المحددة، وتوفر الجامعة دعماً أكاديمياً لاختيار المسار الملائم لكل طالب.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-section","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-section"><div class="wp-block-group__inner-container"><!-- wp:heading {"level":2} -->
<h2>مزايا الدراسة في الجامعة</h2>
<!-- /wp:heading -->
<!-- wp:group {"className":"euss-card-grid","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card-grid"><!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:heading {"level":3} -->
<h3>لغات التدريس</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>العربية والإنجليزية والسويدية ضمن بيئة بحثية داعمة للتنوع الثقافي. <strong>// PDF p.6</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:heading {"level":3} -->
<h3>الكليات المتخصصة</h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>ثماني كليات تشمل الإعلام، الهندسة، القانون، الإدارة، الدراسات العليا، والعلوم الطبية المساعدة. <strong>// PDF p.7</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:heading {"level":3} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>تعليم مدمج يجمع بين الحضور الحضوري والمنصة الافتراضية مدعوماً بمحاضرات مباشرة. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"euss-card-grid","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card-grid"><!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:paragraph -->
<p><strong>العنوان:</strong> Hildebrandsgatan 5, 41705 Gothenburg, Sweden</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><strong>الهاتف:</strong> 0046763091170</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><strong>البريد:</strong> <a href="mailto:info@edu.renita.se">info@edu.renita.se</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:paragraph -->
<p>تتوفر اتفاقيات اعتراف أكاديمي وتوأمة علمية مع جامعات عربية وأوروبية وأمريكية موثقة عبر منظمة الاعتماد الدولية IAO.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="https://www.iao.org/Sweden-Vastra-Gotaland-County/European-University-for-Smart-Sciences" target="_blank" rel="noopener">منصة IAO</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:group -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Established in Gothenburg, Sweden in 2019/2020 under registration 559306-7902, the university connects diverse cultures through three languages of instruction.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>Blended and virtual delivery supports bachelor’s, master’s, doctoral, and accredited professional awards grounded in applied research.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons {"className":"euss-hero-buttons"} -->
<div class="wp-block-buttons euss-hero-buttons"><!-- wp:button {"backgroundColor":"secondary","textColor":"neutral"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-secondary-background-color has-neutral-color has-background has-text-color wp-element-button" href="/admissions">Apply Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
<!-- wp:column {"verticalAlignment":"center","className":"euss-hero-cards"} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">On-campus examinations for resident students with synchronous remote assessments for international cohorts. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-feature-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-feature-card"><!-- wp:heading {"level":3} -->
<h3>Certificate Recognition</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Awards are authenticated by Swedish notaries, the Ministry of Foreign Affairs, and embassies via the apostille process. <strong>// PDF p.19-20</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-feature-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-feature-card"><!-- wp:heading {"level":3} -->
<h3>Study & Examinations</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Distance learners access live virtual classes and may sit exams via Swedish embassies, partner universities, or accredited representatives. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
...
<!-- wp:group {"className":"euss-section euss-section--light","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-section euss-section--light"><div class="wp-block-group__inner-container"><!-- wp:heading {"level":2} -->
<h2>Key Dates &amp; Exams</h2>
<!-- /wp:heading -->
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:list -->
<ul><li>Semester examinations hosted in Gothenburg for resident students. <strong>// PDF p.18</strong></li><li>Virtual evaluation windows with live supervision for remote learners. <strong>// PDF p.18</strong></li><li>International sittings available via Swedish embassies and partner universities. <strong>// PDF p.18</strong></li></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p>Students may request retakes within the scheduled window, supported by academic advisors to align each learner with the right pathway.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:group -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Arabic, English, and Swedish teaching in a research-driven environment. <strong>// PDF p.6</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:heading {"level":3} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Eight specialist colleges spanning media, engineering, law, management, graduate studies, and allied medical sciences. <strong>// PDF p.7</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:heading {"level":3} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Hybrid delivery merges on-campus immersion with an interactive virtual platform and live lectures. <strong>// PDF p.18</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:group -->
...
<div class="wp-block-group euss-card-grid"><!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:paragraph -->
<p><strong>Address:</strong> Hildebrandsgatan 5, 41705 Gothenburg, Sweden</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><strong>Phone:</strong> +46 763091170</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><strong>Email:</strong> <a href="mailto:info@edu.renita.se">info@edu.renita.se</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"className":"euss-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group euss-card"><!-- wp:paragraph -->
<p>The university sustains academic recognition and twinning agreements across Arab, European, and American institutions documented by the International Accreditation Organization (IAO).</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
