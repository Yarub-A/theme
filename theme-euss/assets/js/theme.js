(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($mobileMenu.length) {
            $mobileMenu.on('click', '.dropdown > .dropdown-toggle, .dropdown-submenu > .dropdown-toggle', function (event) {
                if (isDesktop()) {
                    return;
                }
                ...
                const $submenu = $parent.children('.dropdown-menu');
                ...
                if ($parent.hasClass('show')) {
                    ...
                    if ($parent.hasClass('dropdown')) {
                        $parent.siblings('.dropdown.show').each(function () {
                            $(this).removeClass('show').children('.dropdown-menu').slideUp(150, function () {
            ...
            $mobileMenu.on('hidden.bs.offcanvas', function () {
                $(this)
                    .find('.dropdown.show, .dropdown-submenu.show')
                    .removeClass('show')
